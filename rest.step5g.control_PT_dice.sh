...
if [ -d $rest_dir/Overlap/PT_dice_controls ]
then
    rm -r $rest_dir/Overlap/PT_dice_controls
fi

mkdir $rest_dir/Overlap/PT_dice_controls
cd $rest_dir/Overlap/PT_dice_controls
...
########################## Multi Keren
# M K b5s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s0.iter${iter_val}.nii -expr 'notzero(a)' -prefix mask_M.K1.b5s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s0.iter${iter_val}.nii > percentiles_PT.M.K1.b5s0.1D
...
# M K b5s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s5.iter${iter_val}.nii -expr 'notzero(a)' -prefix mask_M.K1.b5s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s5.iter${iter_val}.nii > percentiles_PT.M.K1.b5s5.1D
...
########################## Single Keren
# S K b5s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s0.iter${iter_val}.nii -expr 'notzero(a)' -prefix mask_S.K1.b5s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s0.iter${iter_val}.nii > percentiles_PT.S.K1.b5s0.1D
...
# S K b5s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s5.iter${iter_val}.nii -expr 'notzero(a)' -prefix mask_S.K1.b5s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s5.iter${iter_val}.nii > percentiles_PT.S.K1.b5s5.1D
...
########################## Multi LC
# M L b5s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s0.iter${iter_val}.nii -expr 'notzero(a)' -prefix mask_M.LC.b5s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s0.iter${iter_val}.nii > percentiles_PT.M.LC.b5s0.1D
...
# M L b5s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s5.iter${iter_val}.nii -expr 'notzero(a)' -prefix mask_M.LC.b5s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s5.iter${iter_val}.nii > percentiles_PT.M.LC.b5s5.1D
...
########################## Single LC
# S L b5s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s0.iter${iter_val}.nii -expr 'notzero(a)' -prefix mask_S.LC.b5s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s0.iter${iter_val}.nii > percentiles_PT.S.LC.b5s0.1D
...
# S L b5s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s5.iter${iter_val}.nii -expr 'notzero(a)' -prefix mask_S.LC.b5s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s5.iter${iter_val}.nii > percentiles_PT.S.LC.b5s5.1D
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s0.iter${iter_val}.nii -b mask_M.K1.b5s0.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.M.K1.b5s0.p${percentile}.nii

    this_tile=S_Kb5s0_p${percentile}
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s0.iter${iter_val}.nii -b mask_S.K1.b5s0.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.S.K1.b5s0.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s5.iter${iter_val}.nii -b mask_M.K1.b5s5.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.M.K1.b5s5.p${percentile}.nii

    this_tile=S_Kb5s5_p${percentile}
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s5.iter${iter_val}.nii -b mask_S.K1.b5s5.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.S.K1.b5s5.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s0.iter${iter_val}.nii -b mask_M.LC.b5s0.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.M.LC.b5s0.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s5.iter${iter_val}.nii -b mask_M.LC.b5s5.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.M.LC.b5s5.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s0.iter${iter_val}.nii -b mask_S.LC.b5s0.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.S.LC.b5s0.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s5.iter${iter_val}.nii -b mask_S.LC.b5s5.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.S.LC.b5s5.p${percentile}.nii

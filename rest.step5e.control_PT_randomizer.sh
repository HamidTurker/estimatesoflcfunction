...
mkdir $rest_dir/Overlap/PT_rand
cd $rest_dir/Overlap/PT_rand
...
########################## Multi Keren
# M K b0s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b0s0.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_M.K1.b0s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b0s0.seed${seed_val}.nii > percentiles_PT.M.K1.b0s0.1D
hold=`cat percentiles_PT.M.K1.b0s0.1D`; perc=($hold);
...
# M K b0s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b0s5.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_M.K1.b0s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b0s5.seed${seed_val}.nii > percentiles_PT.M.K1.b0s5.1D
hold=`cat percentiles_PT.M.K1.b0s5.1D`; perc=($hold);
...
# M K b5s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s0.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_M.K1.b5s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s0.seed${seed_val}.nii > percentiles_PT.M.K1.b5s0.1D
hold=`cat percentiles_PT.M.K1.b5s0.1D`; perc=($hold);
...
# M K b5s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s5.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_M.K1.b5s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s5.seed${seed_val}.nii > percentiles_PT.M.K1.b5s5.1D
hold=`cat percentiles_PT.M.K1.b5s5.1D`; perc=($hold);
...
########################## Single Keren
# S K b0s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b0s0.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_S.K1.b0s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b0s0.seed${seed_val}.nii > percentiles_PT.S.K1.b0s0.1D
hold=`cat percentiles_PT.S.K1.b0s0.1D`; perc=($hold);
...
# S K b0s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b0s5.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_S.K1.b0s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b0s5.seed${seed_val}.nii > percentiles_PT.S.K1.b0s5.1D
hold=`cat percentiles_PT.S.K1.b0s5.1D`; perc=($hold);
...
# S K b5s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s0.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_S.K1.b5s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s0.seed${seed_val}.nii > percentiles_PT.S.K1.b5s0.1D
hold=`cat percentiles_PT.S.K1.b5s0.1D`; perc=($hold);
...
# S K b5s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s5.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_S.K1.b5s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s5.seed${seed_val}.nii > percentiles_PT.S.K1.b5s5.1D
hold=`cat percentiles_PT.S.K1.b5s5.1D`; perc=($hold);
...
########################## Multi LC
# M L b0s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b0s0.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_M.LC.b0s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b0s0.seed${seed_val}.nii > percentiles_PT.M.LC.b0s0.1D
hold=`cat percentiles_PT.M.LC.b0s0.1D`; perc=($hold);
...
# M L b0s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b0s5.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_M.LC.b0s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b0s5.seed${seed_val}.nii > percentiles_PT.M.LC.b0s5.1D
hold=`cat percentiles_PT.M.LC.b0s5.1D`; perc=($hold);
...
# M L b5s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s0.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_M.LC.b5s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s0.seed${seed_val}.nii > percentiles_PT.M.LC.b5s0.1D
hold=`cat percentiles_PT.M.LC.b5s0.1D`; perc=($hold);
...
# M L b5s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s5.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_M.LC.b5s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s5.seed${seed_val}.nii > percentiles_PT.M.LC.b5s5.1D
hold=`cat percentiles_PT.M.LC.b5s5.1D`; perc=($hold);
...
########################## Single LC
# S L b0s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b0s0.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_S.LC.b0s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b0s0.seed${seed_val}.nii > percentiles_PT.S.LC.b0s0.1D
hold=`cat percentiles_PT.S.LC.b0s0.1D`; perc=($hold);
...
# S L b0s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b0s5.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_S.LC.b0s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b0s5.seed${seed_val}.nii > percentiles_PT.S.LC.b0s5.1D
hold=`cat percentiles_PT.S.LC.b0s5.1D`; perc=($hold);
...
# S L b5s0
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s0.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_S.LC.b5s0.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s0.seed${seed_val}.nii > percentiles_PT.S.LC.b5s0.1D
hold=`cat percentiles_PT.S.LC.b5s0.1D`; perc=($hold);
...
# S L b5s5
3dcalc -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s5.seed${seed_val}.nii -expr 'notzero(a)' -prefix mask_S.LC.b5s5.nii
3dBrickStat -non-zero -percentile 0 1 100 $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s5.seed${seed_val}.nii > percentiles_PT.S.LC.b5s5.1D
hold=`cat percentiles_PT.S.LC.b5s5.1D`; perc=($hold);
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s0.seed${seed_val}.nii -b mask_M.K1.b5s0.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.M.K1.b5s0.p${percentile}.nii

    this_tile=S_Kb5s0_p${percentile}
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s0.seed${seed_val}.nii -b mask_S.K1.b5s0.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.S.K1.b5s0.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.ME_K1.${subj_name}.b5s5.seed${seed_val}.nii -b mask_M.K1.b5s5.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.M.K1.b5s5.p${percentile}.nii

    this_tile=S_Kb5s5_p${percentile}
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.SE_K1.${subj_name}.b5s5.seed${seed_val}.nii -b mask_S.K1.b5s5.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.S.K1.b5s5.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s0.seed${seed_val}.nii -b mask_M.LC.b5s0.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.M.LC.b5s0.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.ME_LC.${subj_name}.b5s5.seed${seed_val}.nii -b mask_M.LC.b5s5.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.M.LC.b5s5.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s0.seed${seed_val}.nii -b mask_S.LC.b5s0.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.S.LC.b5s0.p${percentile}.nii
...
do
    ...
    3dcalc -overwrite -a $rest_dir/PT/Zcorr1D_PT.rest.SE_LC.${subj_name}.b5s5.seed${seed_val}.nii -b mask_S.LC.b5s5.nii -expr 'step(b)*ispositive(a-'${!this_tile}')' -prefix rmx.S.LC.b5s5.p${percentile}.nii
...
########################## Format overlaps
awk '{OFS=","} {print "'$subj'",$0}' hold.M.K1_LC.b5s0.txt > M.K1_LC.b5s0.iter${seed_val}.txt
awk '{OFS=","} {print "'$subj'",$0}' hold.M.K1_LC.b5s5.txt > M.K1_LC.b5s5.iter${seed_val}.txt
awk '{OFS=","} {print "'$subj'",$0}' hold.S.K1_LC.b5s0.txt > S.K1_LC.b5s0.iter${seed_val}.txt
awk '{OFS=","} {print "'$subj'",$0}' hold.S.K1_LC.b5s5.txt > S.K1_LC.b5s5.iter${seed_val}.txt
awk '{OFS=","} {print "'$subj'",$0}' hold.X.K1.b5s0.txt > X.K1.b5s0.iter${seed_val}.txt
awk '{OFS=","} {print "'$subj'",$0}' hold.X.K1.b5s5.txt > X.K1.b5s5.iter${seed_val}.txt
awk '{OFS=","} {print "'$subj'",$0}' hold.X.LC.b5s0.txt > X.LC.b5s0.iter${seed_val}.txt
awk '{OFS=","} {print "'$subj'",$0}' hold.X.LC.b5s5.txt > X.LC.b5s5.iter${seed_val}.txt
